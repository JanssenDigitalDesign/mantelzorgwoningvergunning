...
export default async function OverOnsPage() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="Over ons"
        h1="Gespecialiseerd in vergunningtekeningen voor mantelzorgwoningen"
        ...
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24">
          ...
          <Reveal delay={100} className="mt-8 space-y-5 text-brand-ink-muted">
            <p>
              ...
              zich specifiek richt op vergunningtekeningen voor mantelzorgwoningen.
            </p>
            <p>
              Die specialisatie maakt het verschil: een mantelzorgwoning heeft een heel eigen
              kader — de zorgindicatie, het tijdelijke karakter van de bewoning en gemeentelijke
              regels die sinds de Omgevingswet kunnen verschillen. Doordat we dagelijks met dit
              type project werken, weten we precies waar een toetser op let en waar een
