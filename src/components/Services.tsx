...
import { HeartHomeIcon, RulerPencilIcon, ShieldCheckIcon, FileCheckIcon } from "@/components/icons";

const ICONS = [HeartHomeIcon, RulerPencilIcon, ShieldCheckIcon, FileCheckIcon];
